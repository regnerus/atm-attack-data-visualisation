...
\item Which factors contribute most to ATM locations being attacked?
...
\captionof{figure}{Visualisation of ATM attacks (red circles), Predicted ATM attacks (orange circles) and ATM locations (black dots) on the map of Lisbon. \cite{c3}}\label{fig:visualisation}
}
...
\captionof{figure}{Confusion matrix of the results. \cite{c3}}\
{fig:confusion}
}
...
\begin{center}
\centering
\captionof{table}{Most Informative Features}
\label{informative}
\begin{tabular}{@{}lllll@{}}
\toprule
Coef    & Feature Name &  &  &  \\ \midrule
-0.4678 & Police\_Dis  &  &  &  \\
-1.0099 & MWay\_Dist   &  &  &  \\
-5.8621 & N\_INCOME    &  &  &  \\
-6.3765 & N\_UNP\_RATE &  &  &  \\
...
-6.6055 & N\_COM\_DENS &  &  &  \\
-6.6429 & N\_AGE       &  &  &  \\
-7.2555 & NUMBER       &  &  &  \\ \bottomrule
\end{tabular}
\end{center}
}

Table \ref{informative} show the features orderd on how informative they are. The top feature is the most informative feature. According to this table the features "Police\_Dis" and "MWay\_Dist" contribute significantly more to the prediction than the other features.


{
\begin{center}
\centering
\captionof{table}{Example features}
\label{examplefeatures}
\begin{tabular}{lllll}
\hline
Feature      & Example 1 & Example 2 & Example 3 &  \\ \hline
MWay\_Dist   & 1000      & 730       &  1480 &  \\
Police\_Dis  & 685       & 500       &  1020 &  \\
N\_UNP\_RATE & 2         & 2         &  2 &  \\
N\_AGE       & 2         & 2         &  2 &  \\
N\_INCOME    & 2         & 2         &  2 &  \\
N\_DENSITY   & 2         & 2         &  2 &  \\
...
\begin{center}
\centering
\captionof{table}{Example results}
...
Some example ATMs were made to test the ability of the classifier to generate attack probabilities the results can be seen in table \ref{exampleresults}. The values for the properties of the example ATMs can be found in table \ref{examplefeatures}. 
...
The data mining approach and can be viewed as a Python Jupyter Notebook file: \url{https://github.com/regnerus/atm-attack-data-visualisation/blob/master/datamining/DM.ipynb}. 

The visualisation created in D3 can be viewed as source code or as live visualisation: \url{https://regnerus.github.io/atm-attack-data-visualisation/}.
